...
<div class="card shadow mb-4">
  ...
  <div class="card-body">
    ...
    <form action="{{ route('post.proses-tambah.kelas') }}" method="post">
      @csrf
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control @error('nama_kelas') is-invalid @enderror" name="nama_kelas" value="{{ old('_kelas', '') }}">
